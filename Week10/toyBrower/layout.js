...
function layout(element) {
  ...
  const style = elementStyle[("width", "height")].forEach((size) => {
  ...
  if (style.flexDirection === "row-revers") {
    mainSize = "width";
    mainStart = "right";
    mainEnd = "left";
    mainSign = -1;
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    if (itemStyle[mainSize] === null) item[mainSize] = 0;
  ...
  if (mainSpace < 0) {
    ...
    flexLines.forEach(function (items) {
      ...
      for (var i = 0; i < items.length; i++) {
        ...
        if (![null, undefined].includes(itemStyle.flex)) {
  ...
  flexLines.forEach(function (items) {
    ...
    for (var i = 0; i < items.length; i++) {
      ...
      if (align === "stretch") {
        ...
        itemStyle[crossSize] = (itemStyle[crossEnd] - itemStyle[crossStart]) * crossSign;
      }
    }
